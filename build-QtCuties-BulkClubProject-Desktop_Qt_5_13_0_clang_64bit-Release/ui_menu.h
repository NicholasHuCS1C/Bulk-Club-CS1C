...
public:
    ...
    void setupUi(QMainWindow *Menu)
    {
        ...
        buttonSearchMonth->setGeometry(QRect(600, 260, 93, 28));
        ...
        labelStatusChange = new QLabel(tabAddPurchase);
        labelStatusChange->setObjectName(QString::fromUtf8("labelStatusChange"));
        labelStatusChange->setGeometry(QRect(520, 480, 171, 16));
        ...
        buttonLogout->setGeometry(QRect(690, 10, 93, 28));
    ...
    void retranslateUi(QMainWindow *Menu)
    {
        ...
        buttonSearchMonth->setText(QCoreApplication::translate("Menu", "Load month", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tabDisplayMembers), QCoreApplication::translate("Menu", "Member Search", nullptr));
